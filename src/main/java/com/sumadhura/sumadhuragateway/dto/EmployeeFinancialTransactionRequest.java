...
@Getter
@Setter
public class EmployeeFinancialTransactionRequest extends Result implements Serializable{  
	private static final long serialVersionUID = -4659277747989999142L;
	private Long empId;
...
//	private String setOffLegalChargesInvoiceNo;
	...
	private List<EmployeeFinModiChargesRequest> modiCostRequests;
	private List<EmployeeFinModiChargesRequest> modiCostDtlsRequests;
	//private AnonymousEntryDetailsRequest ansRequest;
